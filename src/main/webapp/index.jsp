...
<h2>Finally the web app is deployed</h2>
<!-- How to insert an image -->
<img
 alt="Sample image" 
 title="title=&#34;Text to show when mouse is hovered over this image&#34;"
 src="https://cdn.pixabay.com/photo/2022/03/02/13/42/peace-7043225_960_720.jpg"
 style="width:100%;">
<br>
<span style="font-size:84%">
<i>The feeling of relexation</i>  (The app is deployed in tomcat)
</span>

<p>

<a href="https://github.com/dj0408/maven-Odin-web-app">This is the Git repo link</a>
<br>
...
<li><a href="https://www.youtube.com/watch?v=o55C5sEWfp4&t=4493s">Tutorial for UrbanCode Deploy</a>
<li><a href="https://www.youtube.com/watch?v=l2GcnkCEorw&list=PLhW3qG5bs-L_yjwGfRkdySzVKCbV7ciaX&index=8">RobotFramework tutorial</a>
<li><a href="https://www.youtube.com/watch?v=Ii0iPgHsl1E">Jacoco Code coverage tutorial</a>
<li><a href="https://www.youtube.com/watch?v=UjCVCvdI73w">SonarQube tutorial</a>
...
<li><a href="#fluid">Postscript: Cell Phones</a>
</ol>
<p>
...
end with semicolon (<span class="tt">;</span>), like "<span class="tt">&amp;euro;</span>" = "&euro;".  The
...
<dd><span class="tt">&amp;Aacute;</span> (&Aacute;),
<span class="tt">&amp;aacute;</span> (&aacute;),
<span class="tt">&amp;Eacute;</span> (&Eacute;),
<span class="tt">&amp;eacute;</span> (&eacute;),
<span class="tt">&amp;Iacute;</span> (&Iacute;),
<span class="tt">&amp;iacute;</span> (&iacute;),
<span class="tt">&amp;Oacute;</span> (&Oacute;),
<span class="tt">&amp;oacute;</span> (&oacute;),
<span class="tt">&amp;Uacute;</span> (&uacute;),
<span class="tt">&amp;uacute;</span> (&uacute;),
<span class="tt">&amp;Uuml;</span> (&Uuml;),
<span class="tt">&amp;uuml;</span> (&uuml;),
<span class="tt">&amp;Ntilde;</span> (&Ntilde;),
<span class="tt">&amp;ntilde;</span> (&ntilde;);
<span class="tt">&amp;iquest;</span> (&iquest;);
<span class="tt">&amp;iexcl;</span> (&iexcl;).<br>
Example: A&ntilde;orar&aacute;n = <span class="tt">A&amp;ntilde;orar&amp;aacute;n</span>.

<p>

<dt>For <b>German</b> you would need:
<dd><span class="tt">&amp;Auml;</span> (&Auml;),
<span class="tt">&amp;auml;</span> (&auml;),
<span class="tt">&amp;Ouml;</span> (&Ouml;),
<span class="tt">&amp;ouml;</span> (&ouml;),
<span class="tt">&amp;Uuml;</span> (&uuml;),
<span class="tt">&amp;uuml;</span> (&uuml;),
<span class="tt">&amp;szlig;</span> (&szlig;).<br>
Example: Gr&uuml;&szlig;e aus K&ouml;ln = <span class="tt">Gr&amp;uuml;&amp;szlig;e aus K&amp;ouml;ln</span>.
...
<li>Add <span class="tt">&lt;/body&gt;</span> and
...
<p>
<table style="font-size:80%; width:66%; border-top:1px solid black;">
<tr>
...
browser (usually done by clicking on the <b>&#x27f3</b> symbol, or typing
Ctrl-R).
...
can access with a terminal emulator such as <a
href="http://kermitproject.org/">Kermit</a>.  Here's an example that
...
<blockquote>
<pre>
$ <u>cd</u>                      <i>(Change to your login directory)</i>
...
<blockquote>
<pre>
$ <u>cd ~/public_html</u> ("public_html" with underscore)
$ <u>chmod 644 *</u>
</pre>
</blockquote>
...
<blockquote>
<pre>
&lt;img src="<i>filename</i>" alt="brief description"&gt;
</pre>
</blockquote>
<p>
...
<blockquote class="example">&lt;img alt="brief description"
 style="width:50%;
  max-width:480px;
  float:left;
  margin:10px;"
...
<li><a href="https://developer.mozilla.org/en-US/docs/Web/CSS">Cascading
